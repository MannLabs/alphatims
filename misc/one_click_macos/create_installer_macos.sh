...
pip install "../../dist/alphatims-0.2.7-py3-none-any.whl[plotting,stable]"
conda list
...
if false; then
  ...
  pkgbuild --root dist/alphatims --identifier de.mpg.biochem.alphatims.app --version 0.2.7 --install-location /Applications/AlphaTims.app --scripts scripts alphatims.pkg --sign "Developer ID Installer: Max-Planck-Gesellschaft zur Förderung der Wissenschaften e.V. (7QSY5527AQ)"
  ...
  pkgbuild --root dist/alphatims --identifier de.mpg.biochem.alphatims.app --version 0.2.7 --install-location /Applications/AlphaTims.app --scripts scripts alphatims.pkg
