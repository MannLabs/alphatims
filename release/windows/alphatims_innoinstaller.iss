...
#define MyAppVersion "1.0.11-dev0"
...
OutputDir=..\..\
; example for BUILD_NAME: alphatims-1.2.3-windows-amd64
...
[Files]
Source: "..\..\dist_pyinstaller\alphatims_gui\{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
Source: "..\..\dist_pyinstaller\alphatims_gui\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs
